    ...
    <div className='max-w-full min-h-screen flex flex-wrap justify-center items-center'>
      ...
      <div className='sm:w-[50%] w-full  flex justify-end sm:pr-5 sm:py-0 py-5 '>
        <div className='lg:w-[70%] w-full sm:ps-5'>
          ...
          <div className='mt-5 sm:block flex flex-wrap justify-center'>
            <span className='font-semibold text-lg text-[#06CCEC] sm:text-start text-center'>
              Contact Us through what'sapp
            </span>
            <div className='w-full sm:block flex justify-center'>

              <Button className="bg-gradient-to-r from-green-400 via-green-500 to-green-600 text-white hover:bg-gradient-to-br focus:ring-green-300 dark:focus:ring-green-800 rounded-full py-1 mt-5">
                <a
                  href="https://wa.me/923136107654"
                  target="_blank"
